...
class AuthenticationValidatorTestCase(TestCase):
    ...
    @parameterized.expand([
        ...
        param("test_validator_value_2", value="sdfsdfsdfsdf", expected_value="sdfsdfsdfsdf"),
        param("test_validator_value_3", value="8hnjsi48h8h1", expected_value="8hnjsi48h8h1"),
        param("test_validator_value_4", value="dfsdf12312312", expected_value="dfsdf12312312"),
        param("test_validator_value_5", value="1k1i23mk12gg", expected_value="1k1i23mk12gg"),
    ])
